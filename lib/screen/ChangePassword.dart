...
class _ChangePasswordState extends BaseState<ChangePassword> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                        alignment: Alignment.topLeft,
                        child: Text('Proceed to change old one to new ',
                      ...
                      child: Align(
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                text: 'Enter same password in both fields. Use an uppercase letter and a number for stronger password.',
  ...
  checkPasswordError(){
    ...
    if(!cPasswordController.confirmPasswordErrorText(passwordController.text).isEmpty){
      isPasswordValidate = false;
  ...
  void _setUpPassword(
    ...
    try {
      if (checkPasswordError()) {
        RestServerApi()
            .changePassword(
                context, oldPassController.text, passwordController.text)
            .then((value) {
          if (value is bool && value) {
            ...
            showSnackBar(
                    value is String ? value : 'Unable to update Password',isError: true);
          }
        });
      }
    } catch (e) {
